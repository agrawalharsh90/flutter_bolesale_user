...
mixin _$SportsStore on _SportsStore, Store {
  ...
  final _$isSearchingAtom = Atom(name: '_SportsStore.isSearching');
  ...
  final _$productMapAtom = Atom(name: '_SportsStore.productMap');
  ...
  final _$filterProductMapAtom = Atom(name: '_SportsStore.filterProductMap');
