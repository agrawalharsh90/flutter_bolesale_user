...
mixin _$MobileStore on _MobileStore, Store {
  final _$isLoadingAtom = Atom(name: '_MobileStore.isLoading');
  ...
  final _$isSearchingAtom = Atom(name: '_MobileStore.isSearching');
  ...
  final _$productMapAtom = Atom(name: '_MobileStore.productMap');
  ...
  final _$filterProductMapAtom = Atom(name: '_MobileStore.filterProductMap');
  ...
  final _$_MobileStoreActionController = ActionController(name: '_MobileStore');

  @override
  dynamic clearSearchingStore() {
    final _$actionInfo = _$_MobileStoreActionController.startAction();
    try {
      return super.clearSearchingStore();
    } finally {
      _$_MobileStoreActionController.endAction(_$actionInfo);
    }
  }
