...
part of 'kitchenware_store.dart';
...
mixin _$KitchenwareStore on _KitchenwareStore, Store {
  final _$isLoadingAtom = Atom(name: '_KitchenwareStore.isLoading');
  ...
  final _$isSearchingAtom = Atom(name: '_KitchenwareStore.isSearching');
  ...
  final _$productMapAtom = Atom(name: '_KitchenwareStore.productMap');
  ...
  final _$filterProductMapAtom =
      Atom(name: '_KitchenwareStore.filterProductMap');
  ...
  final _$_KitchenwareStoreActionController =
      ActionController(name: '_KitchenwareStore');

  @override
  dynamic clearSearchingStore() {
    final _$actionInfo = _$_KitchenwareStoreActionController.startAction();
    try {
      return super.clearSearchingStore();
    } finally {
      _$_KitchenwareStoreActionController.endAction(_$actionInfo);
    }
  }
