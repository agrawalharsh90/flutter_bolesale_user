...
mixin _$FootwearStore on _FootwearStore, Store {
  final _$isLoadingAtom = Atom(name: '_FootwearStore.isLoading');
  ...
  final _$isSearchingAtom = Atom(name: '_FootwearStore.isSearching');
  ...
  final _$productMapAtom = Atom(name: '_FootwearStore.productMap');
  ...
  final _$filterProductMapAtom = Atom(name: '_FootwearStore.filterProductMap');
  ...
  final _$_FootwearStoreActionController =
      ActionController(name: '_FootwearStore');

  @override
  dynamic clearSearchingStore() {
    final _$actionInfo = _$_FootwearStoreActionController.startAction();
    try {
      return super.clearSearchingStore();
    } finally {
      _$_FootwearStoreActionController.endAction(_$actionInfo);
    }
  }
