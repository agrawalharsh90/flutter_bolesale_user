...
mixin _$FashionStore on _FashionStore, Store {
  final _$isLoadingAtom = Atom(name: '_FashionStore.isLoading');
  ...
  final _$isSearchingAtom = Atom(name: '_FashionStore.isSearching');
  ...
  final _$productMapAtom = Atom(name: '_FashionStore.productMap');
  ...
  final _$filterProductMapAtom = Atom(name: '_FashionStore.filterProductMap');
  ...
  final _$_FashionStoreActionController =
      ActionController(name: '_FashionStore');

  @override
  dynamic clearSearchingStore() {
    final _$actionInfo = _$_FashionStoreActionController.startAction();
    try {
      return super.clearSearchingStore();
    } finally {
      _$_FashionStoreActionController.endAction(_$actionInfo);
    }
  }
