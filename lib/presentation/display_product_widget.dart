                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  itemBuilder: (BuildContext context, index) {
                                    return GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        padding: EdgeInsets.symmetric(
                                            horizontal: ScreenUtil.instance
                                                .setWidth(15)),
                      ...
                      Text(widget.product.product,
                          style: TextStyle(
                              color: Styles.BLACK_COLOR, fontSize: 20)),
                      SizedBox(
                      ...
                      getDetailsRow(
                          "Dispatch in Days", widget.product.dispatch),
  ...
  getProduct() async {
    ...
    try {
      DocumentSnapshot documentSnapshot = await Firestore.instance
          .collection(widget.catId)
          .document(widget.subCatId)
          .get();
      if (documentSnapshot.exists &&
          documentSnapshot.data.isNotEmpty &&
          documentSnapshot.data.containsKey("items") &&
          documentSnapshot.data['items'].isNotEmpty) {
        ...
        data.forEach((value) {
          print("*******");
          print(value);
          Product p = Product.fromJson(jsonDecode(jsonEncode(value)));
          if (p.productID == widget.productId) {
            setState(() {
              widget.product = p;
              widget.initialCount = int.parse(p.moq);
              isLoading = false;
            });
          }
        });
