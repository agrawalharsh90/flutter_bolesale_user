...
class RawNonVegPaymentPage extends StatefulWidget {
  double totalAmount;
  Map<String, dynamic> data;

  RawNonVegPaymentPage({this.data, this.totalAmount});

  @override
  _RawNonVegPaymentPageState createState() => _RawNonVegPaymentPageState();
}

class _RawNonVegPaymentPageState extends State<RawNonVegPaymentPage> {
  int selected = 1;
...
//                                                  context);
  ...
  onPaymentDone(context, bool paid) async {
    widget.data.addAll({'paid': paid});
    await Provider.of<OrderStore>(context).postRawNonVegRequest(widget.data);
